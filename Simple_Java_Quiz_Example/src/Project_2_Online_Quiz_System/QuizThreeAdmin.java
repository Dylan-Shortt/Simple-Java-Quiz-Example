 ...
 */
//*************************************************//
public class QuizThreeAdmin extends javax.swing.JFrame {
    //*************************************************//
    /**
     * Creates new form QuizThreeAdmin
     */
    //*************************************************//
    
    //*************************************************//
    public QuizThreeAdmin() {
        initComponents();
    ...
    public void saveAnswersToTextArea(JTextArea txaAnswers) 
    {
        try {
            //*************************************************//
            // Create a File object for the text file
            File file = new File("Quiz 3 correct answers.txt");
            //*************************************************//
